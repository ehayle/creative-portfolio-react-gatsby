...
import imgWorkCover from "../../assets/image/projects/Berzzerk/berzzerkCover-1440x900.jpg";
import imgS1 from "../../assets/image/projects/Berzzerk/vinyl-1440x900.jpg";
import imgS3 from "../../assets/image/projects/Berzzerk/TurnTable-1080x1080.jpg";
import imgS4 from "../../assets/image/projects/Berzzerk/berzzerkCover-1080x1080.jpg";
import imgS5 from "../../assets/image/projects/Berzzerk/Berzzerk-1440x900.jpg";
      ...
      <PageWrapper>
        ...
        <Section className="mt-lg-5">
          <Container>
            <Row>
              <Col lg="8">
                <Text variant="tag">BRANDING, LOGO</Text>
                <Title variant="secSm" className="my-4">
                  Identifiable branding for BERZZERK.{" "}
                </Title>
                <Text
                  variant="p"
                  css={`
                  ...
                  `}
                >
                  New Jersey based electronic music producer and D.J., BERZZERK.
                </Text>
              </Col>
            </Row>
          </Container>
        ...
        <Section mt="22%" bg="dark">
          <Container>
            ...
            <div className="text-center mt-lg-5">
              ...
              <Link to="/project-pages/frolic-with-me">
                <Button
                  arrowRight
